   ...
   <section class="show-slide mt-20 s-container">
      ...
      <div class="mt-5">
         <div class="mt-3 mb-5 text-xl flex justify-between items-center">
            <p class="font-semibold">Best Employee</p>
         </div>
         <div class="mt-5">
            <DataTable :value="categoryArr" class="p-datatable-sm" responsiveLayout="scroll">
               ...
               <Column field="EmployeeEmail" header="Employee Email"></Column>
               <Column field="NumberofSales" header="Number of Sales"></Column>
            </DataTable>
         </div>
...
import bestemployee from '../../api/reports/bestemployee.js'
