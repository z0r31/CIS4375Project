   ...
   <section class="show-slide mt-20 s-container">
      ...
      <div class="mt-5">
         <div class="mt-3 mb-5 text-xl flex justify-between items-center">
            <p class="font-semibold">Importing Days</p>
         </div>
         <div class="mt-5">
            <DataTable :value="categoryArr" class="p-datatable-sm" responsiveLayout="scroll">
               <Column field="ProductName" header="Product Name"></Column>
               <Column field="Status" header="Status"></Column>
               <Column field="DaysinImporting" header="Days in Importing"></Column>
            </DataTable>
         </div>
...
import importingdays from '../../api/reports/importingdays.js'
